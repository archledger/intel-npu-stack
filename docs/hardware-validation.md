...
workaround for all four original crashers. It also corrected an ABI error in an
earlier research harness: those four inputs have known rank 4 with dynamic batch,
