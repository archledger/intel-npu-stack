...
| Automation | Pinned, least-privilege CI validates source, packages and lifecycle behavior; untrusted changes cannot publish or access qualification secrets. | GitHub workflows and repository controls remain. |
